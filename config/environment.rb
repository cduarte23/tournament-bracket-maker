...
Radiant::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :key => '_tournament-bracket-maker_session',
    :secret      => 'd150a365c676f24e6d7f6a20e7c2916e5e8c595a'
  }
  ...
  config.after_initialize do
    ...
    ActionMailer::Base.smtp_settings = {
      ...
      :domain => "tournament-bracket-maker.com",
      :authentication => :plain,
      :user_name => "questions@tournament-bracket-maker.com",
      :password => "supstar!"
    }
  end
end
